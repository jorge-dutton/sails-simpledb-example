 ...
 */
    ...
    var deleteRow = function (deleteButtonClass, tableElement) {
...
// Initialize users table
    var initUsersTable = function(data) {
      ...
      settings = {
          ...
          "aoColumns": [
              ...
              "<br><button class='btn btn-default datatable-button delete-user--button'><i class='fa fa-trash-o fa-1x'></i></button>"
              }
          ],
          "iDisplayLength": 20,
          "oTableTools": {
      ...
      editRowMenu("edit-user--button", tableElement, function(rowData) {
        setSuitableLeaguesSelect("edit-league-userManagement");
      ...
      deleteRow("delete-user--button", tableElement)
    }
    ...
    var initLeaguesTable = function (data) {
      ...
      settings = {
          ...
          "aoColumns": [
              ...
              "<br><button class='btn btn-default datatable-button delete-league--button'><i class='fa fa-trash-o fa-1x'></i></button>"
              }
          ],
          "iDisplayLength": 20,
          "oTableTools": {
      ...
      filterTableOnSelectChange(table,"league-userManagement",0)
      editRowMenu("edit-league--button", tableElement)
      deleteRow("delete-league--button", tableElement)
    }
    ...
    var initData = function() {
      var initLeagues =  getLeagues;
      initLeagues.success(function(data) {
    ...
    // User data charge function from stringified JSON
   ...
   */
    ...
    var getSuitableLeagues = function() {
      ...
      getAllLeagues.success(function (data) {
        ...
        leagues.forEach(function(league) {
          var leagueEndDate = moment(league[2],'DD/M/YY').format("DD-MM-YYYY");
    ...
    var setSuitableLeaguesSelect = function (selectId) {
      ...
      console.log(suitableLeagues);
      appendOptionInTargetSelect (leaguesSelect, suitableLeagues);
    }
      ...
      if (leaguesFilter.length>0) {
        if (selectElement.data('loaded') !== true) {
          leaguesFilter.forEach(function(leagueOpt) {
            selectElement.append('<option value="'+leagueOpt[0]+'">'+leagueOpt[0]+'</option>');
          })
